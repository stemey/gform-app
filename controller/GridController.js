define([
  ...
  "dijit/_WidgetBase", 
	...
	VirtualVScroller, ColumnResizer, SingleSort, Filter, Focus, RowHeader, RowSelect, json, templateColumns, pageColumns,  _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template){
...
return declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		...
		pageSelected: function(e) {
			...
			//var templateUrl = restHelper.decompose(page.template);
			this.ctx.opener.openSingle({url: "/page/"+e.id, schemaUrl: page.template});
		},
