...
//		gform/util/Resolver
    ...
    return declare("cms.SchemaGenerator", [SchemaGenerator], {
        loadTemplateSchema: function () {
            ...
            t.replace("gform/schema/attributes.json","cms/mongodb/attributes.json");
            t.replace("gform/schema/attributes/header.json","cms/meta/header.json");
            t.replace("gform/schema/group/properties/attribute.json","cms/meta/group-attribute.json");
			...
			t.replace("gform/schema/attributes/properties/groups.json","cms/meta/groups.json");
